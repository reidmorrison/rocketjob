    ...
    module Job
      class ThrottleTest < Minitest::Test
        ...
        describe RocketJob::Batch::Throttle do
          ...
          describe '.has_batch_throttle?' do
            it 'defines the running slices throttle' do
              assert ThrottleJob.has_batch_throttle?(:throttle_running_slices_exceeded?), ThrottleJob.rocket_job_batch_throttles
              refute ThrottleJob.has_batch_throttle?(:blah?), ThrottleJob.rocket_job_batch_throttles
            end
          end
          ...
          describe '.undefine_batch_throttle' do
            it 'undefines the running jobs throttle' do
              ...
              refute ThrottleJob.has_batch_throttle?(:throttle_running_slices_exceeded?), ThrottleJob.rocket_job_batch_throttles
