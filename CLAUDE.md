...
User-facing guides are Jekyll markdown in `docs/` (published to rocketjob.reidmorrison.com; the CNAME is `docs/CNAME`). Edit these for behavior/usage doc changes; serve locally with `cd docs && bundle update && jekyll serve`.
